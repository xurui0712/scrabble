...
/**
 * An {@link AbilityTile} that takes the total word score and triples it.
 * 
 * @author Aaron Reyes
 * 
 */
public class TripleWord extends AbilityTile {

	/**
	 * Constructor method for a TripleWord tile.
	 * 
	 * @param loc
	 ...
	 */
	public TripleWord(Location loc, int priority, color color) {
		super(loc, priority, color);
	}

	@Override
	public int doAbility(List<Player> players, int score) {
		/* just return the score times 3 */
		return 3 * score;
	}
}
